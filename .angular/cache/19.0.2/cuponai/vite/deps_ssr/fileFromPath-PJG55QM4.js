  ...
  "node_modules/node-domexception/index.js"(exports, module) {
    if (!globalThis.DOMException) {
      try {
        const {
          MessageChannel
        } = __require("worker_threads"), port = new MessageChannel().port1, ab = new ArrayBuffer();
...
var FileFromPath = class _FileFromPath {
  ...
  stream() {
    return __asyncGenerator(this, null, function* () {
      const {
        mtimeMs
      } = yield new __await(fs.stat(__classPrivateFieldGet(this, _FileFromPath_path, "f")));
...
*/
//# sourceMappingURL=fileFromPath-PJG55QM4.js.map
