...
import {
  ...
  isFile,
  isFunction
} from "./chunk-GS33LITW.js";
import {
  require_ms,
  require_safer
} from "./chunk-OF3ZY4ZC.js";
import {
...
var require_sbcs_codec = __commonJS({
  "node_modules/encoding/node_modules/iconv-lite/encodings/sbcs-codec.js"(exports) {
    ...
    SBCSEncoder.prototype.write = function(str2) {
      ...
      for (var i = 0; i < str2.length; i++) buf[i] = this.encodeBuf[str2.charCodeAt(i)];
      return buf;
    };
  ...
  "node_modules/encoding/node_modules/iconv-lite/lib/streams.js"(exports, module) {
    ...
    module.exports = function(stream_module) {
      ...
      IconvLiteDecoderStream.prototype._transform = function(chunk, encoding, done) {
        if (!Buffer2.isBuffer(chunk) && !(chunk instanceof Uint8Array)) return done(new Error("Iconv decoding stream needs buffers as its input."));
        try {
          var res = this.conv.write(chunk);
...
var require_lib2 = __commonJS({
  "node_modules/encoding/node_modules/iconv-lite/lib/index.js"(exports, module) {
    ...
    iconv.encode = function encode2(str2, encoding, options) {
      str2 = "" + (str2 || "");
  ...
  "node_modules/agentkeepalive/lib/agent.js"(exports, module) {
    ...
    function installListeners(agent, socket, options) {
      ...
      function onError(err) {
        ...
        debug2("%s(requests: %s, finished: %s) error: %s, listenerCount: %s", socket[SOCKET_NAME], socket[SOCKET_REQUEST_COUNT], socket[SOCKET_REQUEST_FINISHED_COUNT], err, listenerCount);
...
var FormData2 = class {
  ...
  *values() {
  ...
  [(_FormData_setEntry = function _FormData_setEntry2({
    name,
    rawValue,
    append,
    fileName,
...
var FormDataEncoder = class {
  constructor(form, boundaryOrOptions, options) {
    ...
    __classPrivateFieldSet(this, _FormDataEncoder_options, __spreadValues(__spreadValues({}, defaultOptions), options), "f");
...
function fileFromPath2(path, ...args) {
  return __async(this, null, function* () {
    const {
      fileFromPath: _fileFromPath
    } = yield import("./fileFromPath-PJG55QM4.js");
    if (!fileFromPathWarned) {
      console.warn(`fileFromPath is deprecated; use fs.createReadStream(${JSON.stringify(path)}) instead`);
      fileFromPathWarned = true;
    }
    return yield _fileFromPath(path, ...args);
  });
}
var defaultHttpAgent = new import_agentkeepalive.default({
  keepAlive: true,
  timeout: 5 * 60 * 1e3
});
var defaultHttpsAgent = new import_agentkeepalive.default.HttpsAgent({
  keepAlive: true,
  timeout: 5 * 60 * 1e3
});
function getMultipartRequestOptions2(form, opts) {
  return __async(this, null, function* () {
    const encoder = new FormDataEncoder(form);
    const readable = Readable2.from(encoder);
    const body = new MultipartBody(readable);
    const headers = __spreadProps(__spreadValues(__spreadValues({}, opts.headers), encoder.headers), {
...
var AbstractPage = class {
  ...
  getNextPage() {
    return __async(this, null, function* () {
      ...
      return yield __classPrivateFieldGet3(this, _AbstractPage_client, "f").requestAPIList(this.constructor, nextOptions);
    });
  }
  iterPages() {
    return __asyncGenerator(this, null, function* () {
...
var EventStream = class {
  ...
  emitted(event) {
    ...
    return __async(this, null, function* () {
      __classPrivateFieldSet3(this, _EventStream_catchingPromiseCreated, true, "f");
      yield __classPrivateFieldGet4(this, _EventStream_endPromise, "f");
    });
  }
  _emit(event, ...args) {
...
var ChatCompletionStream = class _ChatCompletionStream extends AbstractChatCompletionRunner {
  ...
  [(_ChatCompletionStream_params = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_choiceEventStates = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_currentChatCompletionSnapshot = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_instances = /* @__PURE__ */ new WeakSet(), _ChatCompletionStream_beginRequest = function _ChatCompletionStream_beginRequest2() {
    ...
    if (!snapshot) {
      snapshot = __classPrivateFieldSet4(this, _ChatCompletionStream_currentChatCompletionSnapshot, __spreadProps(__spreadValues({}, rest), {
        choices: []
      }), "f");
    } else {
...
var AssistantStream = class _AssistantStream extends EventStream {
  ...
  finalRun() {
    return __async(this, null, function* () {
      yield this.done();
      if (!__classPrivateFieldGet7(this, _AssistantStream_finalRun, "f")) throw Error("Final run was not received.");
...
_AssistantStream_addEvent = function _AssistantStream_addEvent2(event) {
  ...
  if (!__classPrivateFieldGet7(this, _AssistantStream_finalRun, "f")) throw Error("Final run has not been received");
  return __classPrivateFieldGet7(this, _AssistantStream_finalRun, "f");
      ...
      if (delta.step_details && delta.step_details.type == "tool_calls" && delta.step_details.tool_calls && accumulatedRunStep.step_details.type == "tool_calls") {
        for (const toolCall of delta.step_details.tool_calls) {
          if (toolCall.index == __classPrivateFieldGet7(this, _AssistantStream_currentToolCallIndex, "f")) {
            ...
            if (__classPrivateFieldGet7(this, _AssistantStream_currentToolCall, "f")) this._emit("toolCallCreated", __classPrivateFieldGet7(this, _AssistantStream_currentToolCall, "f"));
          }
        }
      }
  ...
  if (__classPrivateFieldGet7(this, _AssistantStream_runStepSnapshots, "f")[event.data.id]) return __classPrivateFieldGet7(this, _AssistantStream_runStepSnapshots, "f")[event.data.id];
...
var getDefaultOptions = (options) => {
  return typeof options === "string" ? __spreadProps(__spreadValues({}, defaultOptions2), {
    basePath: ["#"],
    definitions: {},
    name: options
  }) : __spreadValues(__spreadProps(__spreadValues({}, defaultOptions2), {
    basePath: ["#"],
    definitions: {}
  }), options);
};
...
humanize-ms/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EPH7JEG4.js.map
