    ...
    return __async(this, arguments, function* (data, values = {}) {
      switch (data._type) {
        case "llm_chain": {
          const {
            LLMChain
          } = yield import("./llm_chain-BNCD4NVI.js");
          return LLMChain.deserialize(data);
        }
        case "sequential_chain": {
          const {
            SequentialChain
          } = yield import("./sequential_chain-ANAIJL6O.js");
        ...
        case "stuff_documents_chain": {
          const {
            StuffDocumentsChain
          } = yield import("./combine_docs_chain-2PA3KLPU.js");
        ...
        case "vector_db_qa": {
          const {
            VectorDBQAChain
          } = yield import("./vector_db_qa-LU5O2WTG.js");
          return VectorDBQAChain.deserialize(data, values);
        }
        case "api_chain": {
          const {
            APIChain
          } = yield import("./api_chain-Z2CDFOIJ.js");
...
//# sourceMappingURL=chunk-QN6VT6LH.js.map
