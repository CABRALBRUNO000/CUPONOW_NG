...
var BasePromptTemplate = class extends Runnable {
  ...
  mergePartialAndUserVariables(userVariables) {
    return __async(this, null, function* () {
      ...
      const allKwargs = __spreadValues(__spreadValues({}, partialValues), userVariables);
      return allKwargs;
    });
  }
  /**
  ...
  invoke(input, options) {
    return __async(this, null, function* () {
      return this._callWithConfig((input2) => this.formatPromptValue(input2), input, __spreadProps(__spreadValues({}, options), {
        runType: "prompt"
      }));
    });
  }
    ...
    return __async(this, null, function* () {
      switch (data._type) {
        case "prompt": {
          ...
          } = yield import("./prompt-V3GUAWG3.js");
        ...
        case void 0: {
          ...
          return PromptTemplate2.deserialize(__spreadProps(__spreadValues({}, data), {
            _type: "prompt"
          }));
        }
        case "few_shot": {
          ...
          } = yield import("./few_shot-3TMVA5CN.js");
...
var PromptTemplate = class _PromptTemplate extends BaseStringPromptTemplate {
  ...
  static fromTemplate(template, options) {
    ...
    return new _PromptTemplate(__spreadValues({
...
mustache/mustache.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-OBIMT5KJ.js.map
